...
#ifdef Q_OS_MACX
QgsGcpCoveragesDialog::QgsGcpCoveragesDialog( QWidget *parent, QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData )
...
#endif
{
  ...
  myHeaders << tr( "Coverage Name / Column Value" ) << tr( "Title / Column-Names" ) << tr( "Abstract / Column-Description" );
  treeWidget->setHeaderLabels( myHeaders );
  mLastDirSettingsName  = QLatin1String( "/UI/lastGcpCoveragesDir" );
  connect( buttonBox->button( QDialogButtonBox::Ok ), &QAbstractButton::clicked, this, &QgsGcpCoveragesDialog::ok );
  connect( buttonBox->button( QDialogButtonBox::Reset ), &QAbstractButton::clicked, this, &QgsGcpCoveragesDialog::load_selected_coverage );
}
...
void QgsGcpCoveragesDialog::init()
{
  ...
  init_TreeWidget();
  connect( treeWidget, &QTreeWidget::itemClicked, this, &QgsGcpCoveragesDialog::tree_coverage_clicked );
}
...
QTreeWidgetItem *QgsGcpCoveragesDialog::createTreeItemCoverages( QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData )
{
  bool b_reinit = false;
  mGcpDbData = parmsGcpDbData;
...
void QgsGcpCoverages::openDialog( QWidget *parent,  QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData )
{
  ...
  if ( !b_valid )
  {
    ...
    connect( pDialog, &QgsGcpCoveragesDialog::selectedRasterCoverage, this, &QgsGcpCoverages::load_selected_coverage );
  }
