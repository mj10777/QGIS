...
class QgsGCPList : public QList<QgsGeorefDataPoint *>
{
  public:
     ...
     */
    bool updateDataPoint( int id_gcp, bool bPointMap, QgsPoint updatePoint );
    /**
     ...
     */
    bool searchDataPoint( QgsPoint searchPoint, bool bPointMap = true, double epsilon = 0.5, int *id_gcp = nullptr, double *distance = nullptr, int *iResultType = nullptr );
  protected:
    /**
     ...
     */
    void setGcpDbData( QgsSpatiaLiteProviderGcpUtils::GcpDbData* parmsGcpDbData, bool bClear ) { mGcpDbData = parmsGcpDbData; if ( bClear ) {clearDataPoints();} };
    /**
