...
class QgsGcpCoveragesDialog : public QMainWindow, private Ui::QgsGcpCoveragesDialogBase
{
    Q_OBJECT
  public:
    QgsGcpCoveragesDialog( QWidget *parent,  QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData );
  ...
  private slots:
    ...
    // Close Dialog
    void ok();
    // Load selected coverage, when not already loaded
  ...
  protected:
    ...
    QTreeWidgetItem *createTreeItemCoverages( QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData );
  private:
    void init();
...
class QgsGcpCoverages : public QObject
{
  ...
  public:
    ...
    void openDialog( QWidget *parent,  QgsSpatiaLiteGcpUtils::GcpDbData *parmsGcpDbData );
  public slots:
