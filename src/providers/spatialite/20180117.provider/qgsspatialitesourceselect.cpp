...
{
  setupUi( this );
#if QGSSPATIALITEDBINFOMODEL
#warning "-I-> Using QgsSpatialiteDbInfoModel"
#else
#warning "-I->  Using QgsSpatiaLiteTableModel"
#endif
  ...
  cmbDbCreateOption->addItem( tr( "Spatialite (basic)" ), QgsSpatialiteDbInfo::Spatialite40 );
  cmbDbCreateOption->addItem( tr( "Spatialite (with Styles, Raster and VectorCoverages Table's)" ), QgsSpatialiteDbInfo::Spatialite50 );
  cmbDbCreateOption->addItem( "GeoPackage", QgsSpatialiteDbInfo::SpatialiteGpkg );
  cmbDbCreateOption->addItem( "MBTiles", QgsSpatialiteDbInfo::SpatialiteMBTiles );
  ...
  mTablesTreeView->header()->setResizeMode( QHeaderView::Stretch ); // QHeaderView::ResizeToContents
...
#if QGSSPATIALITEDBINFOMODEL
  mExpandToDepth = mTableModel.getExpandToDepth();
  // Insures that text is onSync with the QgsSpatialiteDbInfoModel Header-Labels
  mSearchColumnComboBox->addItem( mTableModel.getTableNameText() );
  mSearchColumnComboBox->addItem( mTableModel.getGeometryNameText() );
  mSearchColumnComboBox->addItem( mTableModel.getGeometryTypeText() );
  mSearchColumnComboBox->addItem( mTableModel.getSqlQueryText() );
  // mTablesTreeView defined in 'ui_qgsdbsourceselectbase.h'
  // Default values:
  ...
  mTablesTreeView->expandToDepth( mExpandToDepth );
#else
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_btnSave_clicked
//-----------------------------------------------------------------
void QgsSpatiaLiteSourceSelect::on_btnSave_clicked()
{
  QString sDbCreateOption = cmbDbCreateOption->currentText();
  QgsSpatialiteDbInfo::SpatialMetadata dbCreateOption = ( QgsSpatialiteDbInfo::SpatialMetadata )cmbDbCreateOption->currentData().toInt();
  ...
  switch ( dbCreateOption )
  {
    case QgsSpatialiteDbInfo::Spatialite50:
      sFileName = QString( "empty_Spatialite50.db" );
      break;
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::addClicked
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_cmbConnections_activated
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::buildQuery
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::updateStatistics
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_mTablesTreeView_clicked
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_mTablesTreeView_doubleClicked
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_mSearchTableEdit_textChanged
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_btnNew_clicked
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::collectSelectedTables
//-----------------------------------------------------------------
...
#if QGSSPATIALITEDBINFOMODEL
    QgsDebugMsgLevel( QString( "QgsSpatiaLiteSourceSelect::collectSelectedTables[getItem] " ), 7 );
    currentItem = mTableModel.getItem( mProxyModel.mapToSource( *selected_it ) );
#else
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::addTables
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::on_btnConnect_clicked
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::addDatabaseSource
//-----------------------------------------------------------------
...
void QgsSpatiaLiteSourceSelect::setSpatialiteDbInfo( QgsSpatialiteDbInfo *spatialiteDbInfo, bool setConnectionInfo )
{
  ...
  {
    mTableModel.setSpatialiteDbInfo( spatialiteDbInfo );
#if QGSSPATIALITEDBINFOMODEL
    mExpandToDepth = mTableModel.getExpandToDepth();
#endif
    mTablesTreeView->setColumnHidden( mTableModel.getColumnSortHidden(), true );
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::setSql
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::treeWidgetSelectionChanged
//-----------------------------------------------------------------
...
#if QGSSPATIALITEDBINFOMODEL
    QgsDebugMsgLevel( QString( "QgsSpatiaLiteSourceSelect::treeWidgetSelectionChanged [getItem]" ), 7 );
    currentItem = mTableModel.getItem( mProxyModel.mapToSource( *selected_it ) );
#else
    currentItem = mTableModel.itemFromIndex( mProxyModel.mapToSource( *selected_it ) );
#endif
