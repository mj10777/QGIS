...
void QgsSpatiaLiteSourceSelect::addDatabaseSource( QStringList const &paths, QString const &providerKey )
{
  ...
  else
  {
    ...
    setQgsSpatialiteDbInfo( spatialiteDbInfo );
  }
}
//-----------------------------------------------------------------
// QgsSpatiaLiteSourceSelect::setQgsSpatialiteDbInfo
//-----------------------------------------------------------------
void QgsSpatiaLiteSourceSelect::setQgsSpatialiteDbInfo( QgsSpatialiteDbInfo *spatialiteDbInfo, bool setConnectionInfo )
{
