...
#warning "-I->  Using QgsSpatiaLiteTableModel"
  ...
  cmbDbCreateOption->addItem( tr( "Spatialite (with Styles, Raster and VectorCoverages Table's)" ), QgsSpatialiteDbInfo::Spatialite45 );
  ...
  mTablesTreeView->expandToDepth( 3 );
#else
...
void QgsSpatiaLiteSourceSelect::setSpatialiteDbInfo( QgsSpatialiteDbInfo *spatialiteDbInfo, bool setConnectionInfo )
{
  ...
  {
    mTableModel.setSqliteDb( spatialiteDbInfo );
    // mTablesTreeView->setColumnHidden( mTableModel.getColumnSortHidden(), true );
    mTablesTreeView->sortByColumn( mTableModel.getColumnSortHidden(), Qt::AscendingOrder );
    mTablesTreeView->expandToDepth( 1 );
