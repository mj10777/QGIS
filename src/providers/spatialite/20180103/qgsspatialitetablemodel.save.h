...
class  QgsSpatiaLiteTableModel: public QStandardItemModel
{
  Q_OBJECT public:
    ...
    * \since QGIS 3.0
    */
    void setSqliteDb( QgsSpatialiteDbInfo *spatialiteDbInfo, bool loadGeometrylessTables = false );
