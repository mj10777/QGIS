...
class QgsSpatialiteDbInfoModel : public QAbstractItemModel
{
  ...
  public:
    ...
    * \since QGIS 3.0
    */
    void setSqliteDb( QgsSpatialiteDbInfo *spatialiteDbInfo );
  ...
  private:
    ...
    */
    ...
    /**
     * Fill the model Item based on the read Database
     * \since QGIS 3.0
     */
    bool addDatabaseEntry();
     ...
     * \since QGIS 3.0
     */
    void addTableEntryType( QMap<QString, QString> mapLayers, QgsSpatialiteDbInfoModel::EntryType entryType = QgsSpatialiteDbInfoModel::EntryTypeLayer, QgsSpatialiteDbInfo::SpatialiteLayerType layerType = QgsSpatialiteDbInfo::SpatialiteUnknown );
...
class QgsSpatialiteDbInfoItem : public QObject
{
  ...
  public:
    enum SpatialiteDbInfoItemType
    {
      ...
      ItemTypeColumn = 3,
      ItemTypeAdmin = 4,
      ItemTypeHelpText = 997,
      ItemTypeHelpRoot = 998,
      ItemTypeUnknown = 999
    };
    ...
    QgsSpatialiteDbInfoItem( QgsSpatialiteDbInfoItem *parent, const QString text, int column = -1 );
    QgsSpatialiteDbInfoItem( const QIcon &icon, QgsSpatialiteDbInfoItem *parent, const QString text, int column = -1 );
    ...
    */
     ...
     * - calculated only ItemTypeDb from onInit, retrieved fro paren for others
    * \see sniffTableInfo
    * \since QGIS 3.0
    */
