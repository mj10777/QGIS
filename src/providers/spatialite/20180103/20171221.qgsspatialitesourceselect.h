...
#ifndef QGSSPATIALITEDBINFOMODEL
#define QGSSPATIALITEDBINFOMODEL 0
#endif // QGSSPATIALITEDBINFOMODEL
...
class QgsSpatiaLiteSourceSelect: public QgsAbstractDataSourceWidget, private Ui::QgsDbSourceSelectBase
{
  ...
  public:
    ...
    */
     ...
     */
    void dbChanged();
    void setQgsSpatialiteDbInfo( QgsSpatialiteDbInfo *spatialiteDbInfo, bool setConnectionInfo = false );
  ...
  private:
     ...
     */
#if QGSSPATIALITEDBINFOMODEL
    QgsSpatialiteDbInfoModel mTableModel;
#else
    ...
    * \since QGIS 3.0
    */
    const QString mSpatialiteProviderKey = QStringLiteral( "spatialite45" );
};
